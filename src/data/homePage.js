const homePage = {
  data: {
    //SEO Header Stuff
    pageDescription:
      "FlyTech Flight School  offers flight training in Saint Joseph, MO. We offer private pilot training, instrument rating training, commercial pilot training, and more. Contact us today!",
    pageKeywords:
    ...
    header: {
      ...
      paragraph:
        "Start your aviation journey with FlyTech Flight School. Whether you're looking to fly for fun or pursue a career in aviation, our programs and instructors are here to help you achieve your goals.",
      buttons: [
        {
          name: "Enroll Now",
    ...
    whyElite: {
      upperHeading: "Why FlyTech Flight School",
      heading: "Our Commitment",
      descriptions: [
        "Founded in 2014 with a vision to bring a flight school to the south suburbs of Chicago,  FlyTech Flight School continues to be one of the only complete flight institutions in the area.  Join us and make your flying dreams come true!",
        "FlyTech Flight School and Aircraft Management, LLC is located in Kankakee, just 50 miles south of Chicago. We offer professional and customized flight training programs including one of Chicagoland's only Multi-Engine Accelerated course.",
    ...
    blogfeed: {
      ...
      description:
        "Stay up to date with the latest news, pilot resources and updates from FlyTech Flight School .",
    },
    ...
    testimonials: {
      upperHeading: "The FlyTech Family",
      heading: "Our Students Love Us",
      headingText: [
        "While our main goal is to train future pilots safely and effectively, it’s important to us at FlyTech Flight School that our students have a fun and comfortable environment to practice in. We are proud of the relationships we have built with our students and guests.",
      ...
      reviews: [
        ...
        },
        {
          ...
          body: "After several years and multiple flight schools, FlyTech succeeded where everyone else failed. They found discrepancies in my logbook and insurance that previous schools missed. Thanks to their thorough staff, those mistakes were caught and fixed before becoming a problem. If you’re looking to start flying, this is a great choice. If you're at another flight school and unhappy, I highly recommend switching to FlyTech.",
          author: "David D.",
        },
        {
          title: "Highly Recommended for Serious Pilots",
          body: "Training at FlyTech has been a fantastic experience. The instructors are knowledgeable, patient, and truly invested in student success. Aircraft are well-maintained, and the overall operation runs seamlessly. Pricing is fair and transparent. I highly recommend FlyTech to anyone serious about flying—it’s such an amazing environment and group of people!",
          author: "Tanner G.",
        },
        {
        ...
        },
        {
          ...
          body: "FlyTech is a great school. I really appreciated the flexibility they provide, allowing me to work full-time while earning my PPL at the same time. Cannot thank my instructor Dolly enough for all the hard work she put into getting me ready for my checkride!",
          author: "Josh A.",
        },
        {
        ...
        },
        {
          ...
          body: "FlyTech is an awesome flight school. I have been to a few flight schools in the area, and they are top-notch! I completed my CFI with them, and they helped me feel confident in my teaching and training. The instructors are amazing, and you can tell they have a passion for what they do. If you want to really understand aviation and become a better pilot, this is the place to go!",
          author: "Zach F.",
        },
      ],
    },
