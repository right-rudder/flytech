export const GeneralFAQs = [
  ...
  },
  {
    ...
    content: `Yes! Students who complete all their ratings through FlyTech are guaranteed an interview for a certified flight instructor (CFI) position. Becoming a CFI is a great way to build flight hours and gain experience for a career in aviation. Check out our page about beginning your pilot career as a <a href="/programs/certified-flight-instructor"  class="text-sky-800 hover:underline hover:brightness-125 duration-200">CFI</a> for more details.`,
  },
];
